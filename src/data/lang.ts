const privateLang = {
  en: {
    ...
    "about1": "Я начинающий <span>frontend разработчик</span> c хорошим опытом разработки учебных проектов.",
    "about2": "В процессе обучения мою было выполнено более десятка различных работ, в рамках учебного курса <span>Rolling Scopes School</span>.",
